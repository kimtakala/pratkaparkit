...
- The current layout uses `app.py`, `db.py`, `geo_helpers.py`, `users.py`, `items.py`, `comments.py`, `validation/`, `security/`, `errors/`, `templates/layout.html`, and `sql/schema.sql` + `sql/init.sql`
...
| Classifications  | `items.py`, `sql/schema.sql`, `sql/init.sql`             | Many-to-many classification table        |
